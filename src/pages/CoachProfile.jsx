...
export default function CoachProfile() {
  ...
  const fetchCoachData = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setError(response.data.message || 'Failed to fetch coach data');
        setCoach(null);
      }
    } catch (error) {
      console.error('Error fetching coach data:', error);
      setError(
        'An error occurred while fetching coach data. Please try again later.'
      );
      setCoach(null);
    } finally {
      setLoading(false);
  ...
  const LoadingState = () => (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <p className="text-lg text-gray-600">Loading coach profile...</p>
    </div>
  );
  ...
  const EmptyState = () => (
    <div className="bg-white rounded-xl shadow-md p-8 max-w-md mx-auto mt-20 text-center">
      ...
      <h2 className="text-2xl font-bold text-gray-800 mb-2">No Coach Found</h2>
      <p className="text-gray-600 mb-6">
        We couldn't find any coach data with the provided ID.
      </p>
      <button
        onClick={() => window.history.back()}
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <div className="flex items-center mt-2">
                  <span className="text-[#002E25]/80">{coach.role}</span>
        ...
        <div className="flex items-center p-4 border-t">
          <div
            className={`w-3 h-3 rounded-full ${
              coach.isVerified ? 'bg-green-500' : 'bg-yellow-500'
            } mr-2`}
          ></div>
          <span className="font-medium text-[#002E25]">
            Status: {coach.isVerified ? 'Verified' : 'Pending Verification'}
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="col-span-1">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="font-medium">{coach.country}</div>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="font-medium capitalize">{coach.gender}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-semibold">Sport Specialization</h2>
            ...
            <div className="p-4 bg-indigo-50 rounded-lg">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 mt-1">Primary Sport</div>
              </div>
            </div>
            <div className="mt-6">
              <div className="text-gray-500 text-sm">Coach Since</div>
              <div className="font-medium">
        ...
        <div className="col-span-1">
          <div className="bg-white rounded-xl shadow-md p-6 mb-6">
            ...
            <div className="mb-4">
              ...
              <div className="font-medium">{coach.address}</div>
            </div>
            ...
            <div className="bg-gray-100 rounded-lg overflow-hidden h-64 relative">
              {coach.latitude && coach.longitude ? (
                <MapContainer
                  center={[coach.latitude, coach.longitude]}
                  zoom={15}
                ...
                >
                  ...
                  />
                  <Marker position={[coach.latitude, coach.longitude]}>
                    <Popup>
                      {coach.firstName} {coach.lastName}'s Location
                    </Popup>
                  </Marker>
                </MapContainer>
              ) : (
            ...
            <div className="mt-4 grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="font-medium">{coach.latitude || 'N/A'}</div>
              </div>
              <div>
                <div className="text-gray-500 text-sm">Longitude</div>
                <div className="font-medium">{coach.longitude || 'N/A'}</div>
              </div>
            </div>
          </div>
            ...
            <div className="p-4 bg-red-50 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <div className="font-medium">{coach.bloodGroup}</div>
                </div>
              </div>
            </div>
          </div>
